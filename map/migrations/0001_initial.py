    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, max_length=256, null=True, upload_to="img/"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "video",
                    models.FileField(
                        blank=True, max_length=256, null=True, upload_to="video/"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "worker_type",
                    models.CharField(max_length=256, verbose_name="측정자 소속"),
                ),
                (
                    "worker_name",
                    models.CharField(max_length=256, verbose_name="측정자 성명"),
                ),
                (
                    "front_image",
                    models.ImageField(
                        blank=True, max_length=256, null=True, upload_to="tree/"
                    ),
                ),
                (
                    "north_image",
